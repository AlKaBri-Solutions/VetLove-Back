...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        repoCliente.save(new Cliente("1000000123", "Laura Rodriguez", "rodriguezlaura@gmail.com", "3003003030"));
        ...
        repoCliente.save(new Cliente("1000000987", "Carlos Sanchez", "carlossanchez@outlook.com", "3303303333"));
        ...
        repoCliente.save(new Cliente("1000000543", "Jorge Hernandez", "jorgehernandez@outlook.com", "3703703737"));
        ...
        repoCliente.save(new Cliente("1000000345", "Gabriela Torres", "gabrielatorres@yahoo.com", "4004004040"));
        ...
        repoCliente.save(new Cliente("1000000789", "Valentina Duarte", "valentinaduarte@yahoo.com", "4404404444"));
        ...
        repoCliente.save(new Cliente("1000001009", "Patricia Vargas", "patriciavargas@yahoo.com", "4704704747"));
        repoCliente.save(new Cliente("1000001010", "Jorge Hernandez", "jorgehernandez@hotmail.com", "4804804848"));
        repoCliente.save(new Cliente("1000001011", "Natalia Alvarez", "nataliaalvarez@gmail.com", "4904904949"));
        ...
        repoCliente.save(new Cliente("1000001014", "Fernando Medina", "fernandomedina@gmail.com", "5205205252"));
        repoCliente.save(new Cliente("1000001015", "Lorena Guerrero", "lorenaguerrero@yahoo.com", "5305305353"));
        ...
        repoCliente.save(new Cliente("1000001021", "Valentina Rojas", "valentinarojas@yahoo.com", "5905905959"));
        repoCliente.save(new Cliente("1000001022", "Hector Ramirez", "hectorramirez@hotmail.com", "6006006060"));
        ...
        repoCliente.save(new Cliente("1000001026", "Sebastian Medina", "sebastianmedina@gmail.com", "6406406464"));
        ...
        for (Long i = 1L; i <= 100L; i++) {
            Mascota asociar1 = repoMascota.findById(i).orElse(null); // Manejar el caso de que la mascota no exista
            if (asociar1 != null) {
                Cliente cliente = repoCliente.findById(contadorCliente).orElse(null); // Manejar el caso de que el
                                                                                      // cliente no exista
                if (cliente != null) {
                    asociar1.setDueno(cliente);
                    asociar1.setEstado(repoEstadoMas.findById(1L).orElse(null)); // Manejar el caso de que el estado no
                                                                                 // exista
                    repoMascota.save(asociar1);

                    // Incrementar contadorCliente cada dos iteraciones
                    if (i % 2 == 0) {
                        contadorCliente = (contadorCliente % totalClientes) + 1L; // Asegurarse de no exceder la
